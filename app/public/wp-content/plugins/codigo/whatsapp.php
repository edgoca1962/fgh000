<?php
$contenido = 'Comentario al evento:https://staging.fgh-org.org/eventos/evento-181/';
$contenido = urlencode($contenido);
$contenido = str_replace('+', '%20', $contenido);

/*
 *WhatsApp Chat by redpishi.com
 */
add_action('wp_footer', function () {
   if (!is_admin()) {
      ...
      $whatsup_message = 'Hello👋 %0D%0A I have a question about your product on redpishi.com.';  // use %0D%0A for line break
...
<button type="button" class="btn rounded-3 fs-2 " style="background-color: rgb(34,212,102)">
   <a href="https://wa.me/50670701516/?text=" .$contenido><i class="fa-brands fa-whatsapp"></i></a>
</button>
<!-- Comentario%20al%20evento%3A%0Ahttps%3A%2F%2Fstaging.fgh-org.org%2Feventos%2Fevento-181%2F%27
 -->
...
<div class="card text-black" style="width:18rem;">
   ...
   <!-- style="background-color: rgb(34,212,102);" -->
   <div class="card-footer">
      <button type="button" class="btn rounded-3 fs-2 " style="background-color: rgb(34,212,102)">
         <a href="https://wa.me/50670701516/?text=Comentario%20al%20evento%3A%0Ahttps%3A%2F%2Fstaging.fgh-org.org%2Feventos%2Fevento-181%2F"><i class="fa-brands fa-whatsapp"></i></a>
      </button>
   </div>
</div>
<?php

$contenido = 'Comentario al evento:' . '\n' . 'https://staging.fgh-org.org/eventos/evento-181/';
$contenido = urlencode($contenido);
$contenido = str_replace('+', '%20', $contenido);
