...
class OracionModel
{
   ...
   {
      add_action('init', [$this, 'set_oracion']);
   }
   public function set_oracion()
   {
      $type = 'oracion';
      $labels = $this->get_etiquetas('Oración', 'Oraciones');

      $args = array(
         'capability_type'           => ['oracion', 'oraciones'],
         'map_meta_cap'             => true,
         'labels'                   => $labels,
         'public'                   => true,
         'has_archive'              => true,
         'rewrite'                  => ['slug' => 'oraciones'],
         'show_in_rest'             => true,
         'rest_base'                => 'oraciones',
      ...
      $capabilities = $this->get_capacidades('oracion', 'oraciones');
