<div class="row mb-3">
   <div class="form-check form-switch d-flex justify-content-center">
      <input class="form-check-input" type="checkbox" role="switch" id="opcion_mensual" name="opcion_mensual" checked data-opcion="on">
...
<div class="row mb-3">
   <div id="opcionmensualuno" class="col">
      <div class="col-xl-6 mb-3">
         <div class="d-flex">
            ...
            <input type="number" class="form-control op1mensual" id="npereventosmes1" name="npereventosmes1" min="1" max="100" value="1">
      ...
      <div class="col-xl-6 mb-3">
         ...
         <input type="number" class="form-control op1mensual" id="numerodiaeventomes" name="numerodiaevento" min="1" max="31" value="1" disabled>
   ...
   <div id="opcionmensualdos" class="col">
      <div class="col-xl-6 mb-3">
         <div class="d-flex">
            <div class="col form-control border-0 bg-transparent text-white">Cada</div>
            <input type="number" class="form-control bg-secondary op2mensual" id="npereventosmes2" name="npereventosmes2" min="1" max="100" value="1" disabled>
            <div class="col form-control border-0 bg-transparent text-white">meses</div>
         </div>
      </div> <!-- Cantidad períodos -->
      <div class="col-xl-6">
