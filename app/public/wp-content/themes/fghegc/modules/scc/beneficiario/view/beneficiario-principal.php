   ...
   <div id="logo" class="navbar-brand logo">
      <div class="d-flex justify-content-center animate__animated animate__fadeInDown">
         <a href="<?= esc_url(site_url('/')) ?>">
            <img style="width: 200px; height:auto;" src="<?php echo (has_custom_logo()) ? wp_get_attachment_image_src(get_theme_mod('custom_logo'))[0] : FGHEGC_DIR_URI . '/assets/img/fghblanco.png' ?>" class="rounded bg-white" alt="Logo">
         </a>
      </div>
   </div>
