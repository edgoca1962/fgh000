...
<section id="seccion_beneficiario_single" <?php echo $atributos['ocultarVista'] ?>>
   <form id="asistenia_single" class="needs-validation" <?php echo $atributos['ocultarMantenimiento'] ?>>
   ...
   <form id="beneficiario_single">
      <div class="form-group mb-3" <?php echo $atributos['ocultarBoton'] ?>>
...
<section id="seccion_beneficiario_single_editar" hidden>
   <form id="beneficiario_single_editar" enctype="multipart/form-data" class="needs-validation" novalidate>
      ...
      <div class="form-group mb-3">
         ...
         <button name="eliminar" titulo="Eliminar Beneficiario" msg="Se eliminará el beneficiario y todo su historial de asistencia." type="submit" class="btn btn-danger btn-sm mb-3 me-5" <?php echo $atributos['ocultarElemento'] ?>><span><i class="fa-solid fa-trash-can" <?php echo $atributos['ocultarElemento'] ?>></i></span> Eliminar</button>
