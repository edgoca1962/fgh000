...
?>
<section id="seccion_menu_single" <?php echo $atributos->get_atributo('ocultarVista') ?>>
   <form id="menu_single" class="needs-validation" novalidate>
      ...
      <div class="form-group row mb-3">
         ...
         <div class="col-md-4 mb-3">
            ...
            <select name="post_parent" class="form-select bg-secondary border-0" aria-label="Comedores" disabled editar>
               <?php foreach ($atributos->get_atributo('comedores') as $comedor) : ?>
      ...
      <div id="menu_botones" class="form-group mb-3" hidden>
         ...
         <button name="eliminar" titulo="Eliminar Menu" msg="Se eliminará el menu." type="submit" class="btn btn-danger btn-sm mb-3 me-5" <?php echo $atributos->get_atributo('ocultarElemento') ?>><span><i class="fa-solid fa-trash-can" <?php echo $atributos->get_atributo('ocultarElemento') ?>></i></span> Eliminar</button>
