...
/**
 * 
 * Plantilla para la inclusión de comedores
 * 
 * @package:EGC001
 * 
 */
...
?>
<section class="my-5 container" <?php echo $atributos->get_atributo('ocultarVista') ?>>
      ...
      <div class="col d-flex justify-content-center align-items-center my-3">
         <div style="width: 200px; overflow:hidden; ">
            <div class="card h-100">
               <img id="imagennueva" src="<?php echo EGC001_DIR_URI . '/assets/img/scc/scccomedores.png' ?>" class="object-fit-cover rounded" alt="Imágen del comedor" style="width: 200px;">
      ...
      <div class="form-group row">
         <div class="col-md-4 mb-3">
            ...
            <select id="provincia" name="provincia" class="form-select" aria-label="Provincias">
               ...
               <?php foreach ($atributos->get_atributo('provincias') as $provincia) : ?>
