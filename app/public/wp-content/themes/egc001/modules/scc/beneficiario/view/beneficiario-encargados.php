...
<section id="encargados" class="mt-5" <?php echo $atributos['ocultarVista'] ?>>
   <div class="row row-cols-1 row-cols-md-3 g-4">
      <?php foreach ($encargados as $encargado) : ?>
         <div class="col">
            <div class="card h-100 shadow">
               <img src="<?php echo (get_user_meta($encargado->ID, 'custom_avatar', true)) ? wp_get_attachment_url(get_user_meta($encargado->ID, 'custom_avatar', true)) : EGC001_DIR_URI . '/assets/img/DiosdePactos/avatar03.png' ?>" alt="Imágen Encargado">
               <div class="card-body">
