...
?>
<section id="scc_usuarios" class="mt-5" <?php echo $atributos['ocultarVista'] ?>>
      ...
      <div class="col-md-6">
         <form id="mantener_usuario" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="col d-flex justify-content-center align-items-center my-3">
               <div class="card">
                  <img id="imagennueva" src="<?php echo (get_user_meta(get_current_user_id(), 'custom_avatar', true)) ? wp_get_attachment_url(get_user_meta(get_current_user_id(), 'custom_avatar', true)) : EGC001_DIR_URI . '/assets/img/DiosdePactos/avatar03.png' ?>" class="object-fit-cover rounded" alt="Imágen del Usuario" style="width: 200px;">
