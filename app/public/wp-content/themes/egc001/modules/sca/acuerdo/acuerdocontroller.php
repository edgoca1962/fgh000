...
namespace EGC001\Modules\Sca\Acuerdo;
...
class AcuerdoController
{
   ...
   public function get_atributos($postType = 'acuerdo')
   {
      ...
      $this->atributos['imagen'] = (get_the_post_thumbnail()) ? get_the_post_thumbnail() : EGC001_DIR_URI . '/assets/img/sca/mcssca.jpg';
      $this->atributos['titulo'] = $this->get_titulo($comite_id, $asignar_id, $vigencia);
      $this->atributos['displaysub'] = 'display-3';
   ...
   {
      if (is_single()) {
         $templatepart = 'modules/sca/acuerdo/view/acuerdo-single';
      } else {
         if (is_page()) {
            $templatepart = 'modules/sca/acuerdo/view/' . get_post(get_the_ID())->post_name;
            if (is_front_page() || is_page('acuerdo-principal')) {
            ...
            $templatepart = 'modules/sca/acuerdo/view/acuerdo';
         }
      }
      return $templatepart;
   }
