...
/**
 * Plantilla para la pagina single de acuerdos.
 * 
 * @package EGC001
 */
...
<?php if ($acuerdo->get_verAcuerdos()[get_post_meta($post->ID, '_comite_id', true)] == 'todos' || get_current_user_id() == get_post_meta($post->ID, '_asignar_id', true)) : ?>

   <div id="elemento_<?php echo get_the_ID() ?>">
      <div class="card mb-5 shadow" style="background: linear-gradient(to right, rgba(64, 154, 247, 1), rgba(43, 170, 177, 1)) !important; color: #fff;">
         <div class="card-header pt-4 row d-flex">
            <div class="col-12 col-md-8 d-flex justify-content-start justify-content-md-start">
               <h6><i class="fa-solid fa-handshake me-3"></i>
                  <?php echo 'Fecha de compromiso: ' . get_post_meta($post->ID, '_f_compromiso', true) ?>
               </h6>
            </div>
   ...
   <div class="modal fade text-black " id="modal_<?php echo get_the_ID() ?>" tabindex="-1" aria-labelledby="lbl_editar" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content" style="background: rgba(255, 224, 0, 0.9)">
            ...
            <div class="modal-body">
               <form id="editar_acuerdo_<?php echo get_the_ID() ?>" class="needs-validation" novalidate>
                  <div class="row gy-2 gx-3 align-items-center">
                     ...
                     <div class="col-md-4 mb-3">
                        <div class="form-check form-switch pt-3">
                           ...
                           <input class="form-check-input" type="checkbox" role="switch" id="vigente_<?php echo get_the_ID() ?>" name="vigente" checked>
                  ...
                  <input type="hidden" name="endpoint" value="<?php echo admin_url('admin-ajax.php') ?>">
                  <input id="elemento_id_<?php echo get_the_ID() ?>" type="hidden" name="post_id" value="">
...
<?php else : ?>
   <h3>No tiene autorización para ver esta información</h3>
<?php endif; ?>