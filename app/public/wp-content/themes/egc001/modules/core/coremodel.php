...
class CoreModel
{
   ...
   {
      add_action('wp_ajax_nopriv_ingresar', [$this, 'EGC001_ingresar']);
      add_action('wp_ajax_cambiar_clave', [$this, 'EGC001_cambiar_clave']);
      add_action('wp_ajax_csvfile', [$this, 'EGC001_csvfile']);
      // add_action('admin_menu', [$this, 'EGC001_export_posts_to_csv']);
      $this->set_paginas();
   }
   public function EGC001_ingresar()
   {
   ...
   public function EGC001_cambiar_clave()
   {
   ...
   public function EGC001_csvfile()
   {
   ...
   public function EGC001_export_miembros_to_csv()
   {
      global $wpdb;
