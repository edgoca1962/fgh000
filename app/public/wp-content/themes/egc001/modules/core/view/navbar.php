         ...
         <div id="logo" class="navbar-brand logo">
            <div class="d-flex justify-content-center">
               <a href="<?= esc_url(site_url('/')) ?>">
                  <img style="width: 50px; height:auto;" src="<?php echo (has_custom_logo()) ? wp_get_attachment_image_src(get_theme_mod('custom_logo'))[0] : EGC001_DIR_URI . '/assets/img/fghblanco.png' ?>" alt="Logo">
               </a>
            </div>
         </div>
         <div>
            <div class="row">
               <?php if (is_user_logged_in()) : ?>
                  <div id="menuAvatarMenu" class="col navbar nav-item me-3">
                     <div class="col-2">
                        <img src="<?php echo (get_user_meta(get_current_user_ID(), 'custom_avatar', true)) ? wp_get_attachment_url(get_user_meta(get_current_user_ID(), 'custom_avatar', true)) : EGC001_DIR_URI . '/assets/img/avatar.png' ?>" class="rounded-circle" style="height: 40px; width:40px;" alt="Imágen Encargada">
                     </div>
                  </div>
               <?php endif; ?>
