      ...
      <div class='position-relative'>
         <div class="d-flex justify-content-center">
            <a href="<?php echo esc_url(site_url('/')) ?>" style="z-index:5">
               <img class="rounded-circle" style="width: 100px; height:auto;" src="<?php echo (has_custom_logo()) ? wp_get_attachment_image_src(get_theme_mod('custom_logo'))[0] : EGC001_DIR_URI . '/assets/img/avatar.png' ?>" alt="Logo">
            </a>
         </div>
