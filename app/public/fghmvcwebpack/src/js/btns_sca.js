...
document.addEventListener('touchstart', f_click)
   ...
   switch (post_type) {
      ...
      case 'acuerdo':
         ...
         document.getElementById('vigente_' + post_id).addEventListener('change', function () {
            console.log('antes editando vigente_' + post_id, 'Value', document.getElementById('vigente_' + post_id).value)
            document.getElementById('vigente_' + post_id).value = 'off'
            ...
            console.log('despues editando vigente_' + post_id, 'Value', document.getElementById('vigente_' + post_id).value)
         })
         */
         break;
