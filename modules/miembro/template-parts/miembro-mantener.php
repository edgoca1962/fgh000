   ...
   <div class="row">
      <div class="col-xl-8">
         <div class="row row-cols-md-2 g-4 mb-3">
            <div class="col-md">
               <button id="btn_mantener_miembro" type="button" class="btn" data-bs-toggle="modal"
                  data-bs-target="#comiteModal">
                  <div id="m_comites" class="card shadowcss"
            ...
            <div class="col-md">
               <button id="btn_mantener_usuario" type="button" class="btn" data-bs-toggle="modal"
                  data-bs-target="#usuarioModal">
                  <div id="m_usuarios" class="card shadowcss"
                     style="background: linear-gradient(to right, rgba(64, 154, 247, 1), rgba(43, 170, 177, 1)) !important;color: #fff;">
                     <div class="d-flex align-items-center p-4">
            ...
            <div class="col-md">
               <button id="btn_agregar_puesto" type="button" class="btn" data-bs-toggle="modal"
                  data-bs-target="#puestoModal">
                  <div id="m_puestos" class="card shadowcss"
                     style="background: linear-gradient(to right, rgba(64, 154, 247, 1), rgba(43, 170, 177, 1)) !important;color: #fff;">
                     <div class="d-flex align-items-center p-4">
      ...
      <div class="col-xl-4">
         <?php get_template_part('modules/acuerdo/template-parts/acuerdo-busquedas') ?>
      </div>
   </div>
         ...
         <div class="modal-content" style="background-color: rgba(174, 102, 221, 1);">
            <form id="mantener_membresia" class="needs-validation" novalidate>
               <div class="modal-header">
                  ...
                  <button id="btn_cerrar_miembro" type="button" class="btn-close" data-bs-dismiss="modal"
               ...
               <div class="modal-footer">
                  ...
                  <button id="btn_modificar_miembro" type="submit" class="btn btn-warning mx-3 disabled">Modificar
                     Miembro</button>
         ...
         <div class="modal-content" style="background-color: rgba(174, 102, 221, 1);">
            <form id="mantener_usuario" class="needs-validation" novalidate>
               <div class="modal-header">
                  ...
                  <button id="btn_cerrar_usuario" type="button" class="btn-close" data-bs-dismiss="modal"
                     aria-label="Close"></button>
               </div>
               <div class="modal-body">
                  <div class="row row-cols-md-3 g-3 mb-3">
               ...
               <div class="modal-footer">
                  ...
                  <button id="btn_modificar_usuario" type="submit" class="btn btn-warning mx-3 disabled">Modificar
                     Usuario</button>
         ...
         <div class="modal-content" style="background-color: rgba(174, 102, 221, 1);">
            <form id="mantener_puesto" class="needs-validation" novalidate>
               <div class="modal-header">
                  ...
                  <button id="btn_cerrar_puesto" type="button" class="btn-close" data-bs-dismiss="modal"
                     aria-label="Close"></button>
               </div>
               <div class="modal-body">
                  <div class="row row-cols-md-2 g-3 mb-3">
                     <div class="col-md">
                        ...
                        <input id="nombrePuesto" class="form-control" name="nombrePuesto" type="text" list="puestos"
                           required>
                        <datalist id="puestos">
                           <?php
               ...
               <div class="modal-footer text-center">
                  ...
                  <button id="btn_modificar_puesto" type="submit" class="btn btn-warning mx-3 disabled">Modificar
                     Puesto</button>
