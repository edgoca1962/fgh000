<?php
require get_template_directory() . "/modules/miembro/inc/miembro.php";
 ...
 * 
 * 
 * Parámetros para miembro.
 * 
 * 
 *****************************************************************************/
if (!function_exists('fgh000_get_miembro_param')) {
   function fgh000_get_miembro_param($postType = 'miembro')
   {
      $atributos = [];
