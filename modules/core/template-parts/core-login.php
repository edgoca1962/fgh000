<section id="hero-page" class="d-flex flex-column justify-content-center align-items-center text-white"
   style="background: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(<?php echo fgh000_get_param(get_post_type(), true)['imagen'] ?>) no-repeat center /cover; height: <?php echo fgh000_get_param(get_post_type(), true)['height'] ?>;">
            ...
            <div class='position-relative'>
               <div class="d-flex justify-content-center">
                  <a href="<?php echo esc_url(site_url('/')) ?>" style="z-index:5">
                     <img class="rounded-circle border border-3 shadowcss"
               ...
               <div class="ingreso-bg p-5 rounded-5 shadowcss" style="margin-top:-2.3rem; width:20rem;">
                  <form class="" id="ingreso" novalidate>
                     ...
                     <div class="d-flex form-floating mb-3 border-bottom">
                        <input type="password" class="form-control bg-transparent border-0 shadow-none text-white"
                           id="clave" name="clave" placeholder="contraseña" required>
                        <label for="clave">Contraseña</label>
                        <span class="mt-4" id="ver_clave" style="font-size: 70%;"><i
                              class="fa-solid fa-eye-slash"></i></i></span>
                        <div class="invalid-feedback">
                     ...
                     <div class="text-center form-group">
                        <button type="submit" class="btn btn-warning btn-lg mb-3"><i class="fas fa-sign-in-alt"></i>
                           Ingresar</button>
                     </div>
