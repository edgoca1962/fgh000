...
<button id="btn_agregar_acuerdo" type="button" class="mb-5 btn btn-warning" data-bs-toggle="modal"
      ...
      <div class="modal-content text-black" style="background: rgba(255, 224, 0, 0.9)">
         <div class="modal-header">
            <h1 class="modal-title fs-5" id="lbl_mantenimiento">
               Agregar Acuerdo:
               <?php echo fgh000_get_param(get_post_type())['subtitulo'] ?>
            </h1>
            ...
            <form id="agregar_acuerdo" class="row g-3 needs-validation" novalidate>
               <div class="row gy-2 gx-3 align-items-center">
                  <div class="col-md-4 mb-3">
                     ...
                     <input type="number" class="form-control" id="n_acuerdo" name="n_acuerdo"
                        value="<?php echo fgh000_get_param(get_post_type())['consecutivo'] ?>"
                        data-n_acuerdos="<?php echo fgh000_get_param(get_post_type())['num_acuerdos'] ?>" required>
                  ...
                  <div class="col-md-4 mb-3">
                     ...
                     <input type="text" class="form-control text-bg-secondary" id="mes_acuerdo" name="mes_acuerdo"
                        value="<?php echo date('m', strtotime(get_post_meta(fgh000_get_param(get_post_type())['acta_id'], '_f_acta', true))) ?>"
                        readonly>
                     <div class="invalid-feedback">
                        Favor no dejar en blanco.
                     </div>
                  ...
                  <div class="col-md-4 mb-3">
                     ...
                     <input type="text" class="form-control text-bg-secondary" id="year_acuerdo" name="year_acuerdo"
                        value="<?php echo date('Y', strtotime(get_post_meta(fgh000_get_param(get_post_type())['acta_id'], '_f_acta', true))) ?>"
                        readonly>
                     <div class="invalid-feedback">
                        Favor no dejar en blanco.
                     </div>
               ...
               <div class="row gy-2 gx-3 align-items-center">
                  <div class="col-md-4 mb-3">
                     ...
                     <input id="f_compromiso_agregar" type="date" class="form-control" name="f_compromiso"
                  ...
                  <div class="col-md-4 mb-3">
                     <div class="form-check form-switch pt-3">
                        <input class="form-check-input" type="checkbox" role="switch" id="vigente_agregar"
                  ...
                  <div class="col-md-4 mb-3">
                     ...
                     <input id="f_seguimiento_agregar" type="date" class="form-control" name="f_seguimiento" value=""
                        disabled>
                  </div>
               </div>
               <div class="row mb-3">
               ...
               <div class="row form-outline mb-3">
                  <textarea class="form-control is-valid" name="contenido" id="contenido_agregar"
               ...
               <input type="hidden" name="comite_id"
                  value="<?php echo fgh000_get_param(get_post_type())['comite_id'] ?>">
               <input type="hidden" name="acta_id" value="<?php echo fgh000_get_param(get_post_type())['acta_id'] ?>">
               <input type="hidden" name="n_acta" value="<?php echo fgh000_get_param(get_post_type())['subtitulo'] ?>">
