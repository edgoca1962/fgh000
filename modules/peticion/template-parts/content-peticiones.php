<section class="row">
   <form id="peticiones" class="needs-validation" novalidate>
      <h2 class="mb-3">Envíanos tu Petición</h2>
      ...
      <div class="form-group">
         ...
         <input type="hidden" name="nonce" value="<?= wp_create_nonce('peticiones') ?>">
         <input type="hidden" name="endpoint" value="<?= admin_url('admin-ajax.php') ?>">
         <input type="hidden" name="f_peticion" value="<?= date('Y-m-d H:i');  ?>">
